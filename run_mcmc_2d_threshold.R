...
keeps <- list(
  ...
  rho = array(NA, dim = c(R*n_chns/thin,5)),
...
for (i in 1:(R + B)){
  ...
  if (ind == FALSE){
    ...
    c1 = 1 - sum(rho[c(2,3,5)]^2) + prod(rho[c(3,5)])^2
    c2 = 1 - sum(rho[c(2,4,5)]^2) + prod(rho[c(4,5)])^2
    end1 = (-b1 + c(-1,1)*sqrt(b1^2 - 4*a*c1)) / (2*a)
    end2 = (-b2 + c(-1,1)*sqrt(b2^2 - 4*a*c2)) / (2*a)
    hat <- uniroot(f,c(max(min(end1),min(end2))+0.0001,min(max(end1),max(end2))-0.0001))$root %>% tryCatch(error = function(e) {rho[1]})
    ...
    c1 = 1 - sum(rho[c(1,3,5)]^2) + prod(rho[c(3,5)])^2
    c2 = 1 - sum(rho[c(1,4,5)]^2) + prod(rho[c(4,5)])^2
    end1 = (-b1 + c(-1,1)*sqrt(b1^2 - 4*a*c1)) / (2*a)
    end2 = (-b2 + c(-1,1)*sqrt(b2^2 - 4*a*c2)) / (2*a)
    hat <- uniroot(f,c(max(min(end1),min(end2))+0.0001,min(max(end1),max(end2))-0.0001))$root %>% tryCatch(error = function(e) {rho[2]})
  ...
  b2 = -2*prod(rho[c(1,2,4)])
  c1 = 1 - sum(rho[c(1,2,3)]^2) + prod(rho[1:2])^2
  c2 = 1 - sum(rho[c(1,2,4)]^2) + prod(rho[1:2])^2
  end1 = (-b1 + c(-1,1)*sqrt(b1^2 - 4*a1*c1)) / (2*a1)
  end2 = (-b2 + c(-1,1)*sqrt(b2^2 - 4*a2*c2)) / (2*a2)
  hat <- uniroot(f,c(max(min(end1),min(end2))+0.0001,min(max(end1),max(end2))-0.0001))$root %>% tryCatch(error = function(e) {rho[5]})
