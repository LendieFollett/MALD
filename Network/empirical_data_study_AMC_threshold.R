...
getSymbols("GME",from = "2021-05-15",to = "2021-12-31")
...
getSymbols("^GSPC",from = "2021-05-15",to = "2021-12-31")
SP500 <- as.data.frame(`GSPC`)
SP500$Date <- as.Date(rownames(SP500))
getSymbols("MRNA",from = "2021-05-15",to = "2021-12-31")
...
keeps <- readRDS(paste0("keeps/keeps_","SVMALD" ,"_","AMC", ".rds"))
...
saveRDS(keeps,paste0("keeps/keeps_",models$model[k] ,"_AMC_",threshold,".rds"))
}
}
